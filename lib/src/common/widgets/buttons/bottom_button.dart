      ...
      return detailsController.productDetails.value.detailedProducts == null
          ...
          ? Row(
            children: [
              AppCardContainer(
                onTap: () {
                  Log.d(detailsController.productCount.toString());
                  detailsController.onAddToCart().then(
                    (value) => detailsController.isAddedToCart.value = true,
                  );
                },
                height: 50,
