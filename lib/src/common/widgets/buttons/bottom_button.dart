        ...
        children: [
          ...
          onTap: () {
            ...
            detailsController.productDetails.value.detailedProducts!
                ...
                1,
                detailsController.productDetails.value.detailedProducts!.preorderAvailable).then((value) {
                  AppHelperFunctions.showToast(cartController.addToCartResponse.value.message!);
                  Get.back();
                  bottomNavController.jumpToTab(2);
            })
                ...
                productId: detailsController.productDetails
                    .value.detailedProducts!.id!).then((value) {
                      AppHelperFunctions.showToast(cartController.requestStockResponse.value.message!);
            })
                : null;
          },
          height: 50,
