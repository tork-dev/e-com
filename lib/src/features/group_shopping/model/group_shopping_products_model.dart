...
class GroupShoppingProductsResponse {
  List<Datum>? data;
  bool? success;
  int? status;

  GroupShoppingProductsResponse({
    this.data,
    this.success,
    this.status,
  });

  factory GroupShoppingProductsResponse.fromJson(String str) => GroupShoppingProductsResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory GroupShoppingProductsResponse.fromMap(Map<String, dynamic> json) => GroupShoppingProductsResponse(
