    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Obx(() {
            return !groupShoppingController.hittingApi.value && groupShoppingController.groupShoppingGroup.value.popular!.isNotEmpty?
            SizedBox(
              height:370,
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: Text(
                                groupShoppingController.groupShoppingGroup
                                    .value.popular![index].product?.name ?? '',
                              ...
                              child: Row(
                                ...
                                children: [
                                  AppBannerImage(
                                    ...
                                    isNetworkImage: groupShoppingController.groupShoppingGroup.value.popular![index].groupAdmin?.avatar != null,
                                    imgUrl: groupShoppingController.groupShoppingGroup.value.popular![index].groupAdmin?.avatar ?? AppImages.avatarIcon,
                                  ),
                                  const Gap(AppSizes.sm),
                                  Expanded( // Use Expanded to allow RichText to use remaining space
                                    child: RichText(
                                      ...
                                      text: TextSpan(
                                        ...
                                        children: [
                                          TextSpan(
                                            text: groupShoppingController.groupShoppingGroup.value.popular![index].groupAdmin?.name ?? '',
                            ...
                            SizedBox(
                              ...
                              child: AppButtons.largeFlatFilledButton(
                                  ...
                                  onPressed: () {
                                    Get.toNamed('/group-shopping/${groupShoppingController.groupShoppingGroup.value.popular![index].token}', parameters: {
