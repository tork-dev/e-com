            ...
            Obx(() {
              return !groupShoppingController.hittingApi.value &&
                      groupShoppingController
                              .groupShoppingGroup.value.popular !=
                          null
                  ? SizedBox(
                      height: 332,
                                          ...
                                          children: [
                                            Visibility(
                                              ...
                                              child: Row(
                                                children: [
                                                  Text(
                                                    "৳${groupShoppingController.groupShoppingGroup.value.popular![index].product!.price}",
                                            ...
                                            Text(
                                              "৳${groupShoppingController.groupShoppingGroup.value.popular![index].product!.salePrice}",
                                              textAlign: TextAlign.left,
