...
class GroupShoppingHeaderPart extends StatelessWidget {
  const GroupShoppingHeaderPart({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: Theme.of(
                    context,
                  ).textTheme.labelLarge!.apply(color: AppColors.darkGrey),
                ),
                ...
                Obx(() {
                  final products =
                      groupShoppingController.groupShoppingProduct.value.data ??
                      [];
                                        ...
                                        Stack(
                                          children: [
                                            ...
                                            AppCardContainer(
                                              ...
                                              child: Text(
                                                "Required: ${product.groupMemberQuantity} Members",
                                                style: Theme.of(
                                                  context,
