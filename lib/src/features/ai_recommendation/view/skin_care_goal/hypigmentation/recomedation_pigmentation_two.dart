...
import 'package:kirei/src/features/ai_recommendation/view/skin_care_goal/hypigmentation/recomedation_pigmentation_three.dart';
...
class RecommendationPigmentationTwo extends StatelessWidget {
  const RecommendationPigmentationTwo({super.key});
          ...
          children: [
            ...
            CheckBoxQuestionImageWidget(
              question: QuestionAndValues().recommendationQuestionAndAns[
                  "related_questions_based_on_primary_concern"]["hypigmentation"]["questions"][1]["question"],
              option: QuestionAndValues().recommendationQuestionAndAns[
                  "related_questions_based_on_primary_concern"]["hypigmentation"]["questions"][1]["options"],
              images: QuestionAndValues().recommendationQuestionAndAns[
                  "related_questions_based_on_primary_concern"]["hypigmentation"]["questions"][1]["images"],
            ),
            const Gap(AppSizes.md),
            ButtonRow(
              onTapNext: (){
                recommendationController.pigmentationTwoSelected = recommendationController.checkboxSelectedValues
