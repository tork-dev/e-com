...
//
// class RecommendationGoalFour extends StatelessWidget {
//   const RecommendationGoalFour({super.key});
//
//   @override
...
//               linearPercent: 4/6,
//               linearPercentString: '4/6',
//             ),
//             const Gap(AppSizes.md),
//             RadioQuestionWidget(
//               question: QuestionAndValues().recommendationQuestionAndAns[
//                   "skincare_goal_questions"]["questions"][3]["question"],
//               option: QuestionAndValues().recommendationQuestionAndAns[
//                   "skincare_goal_questions"]["questions"][3]["options"],
//             ),
//             const Gap(AppSizes.md),
//             ButtonRow(
//               onTapNext: (){
//                 recommendationController.afterShower.value = String.fromCharCode(65 + recommendationController.radioButtonSelectedValue.value!).toLowerCase();
//                 Log.d(recommendationController.afterShower.toString());
//                 Get.to(()=> const RecommendationGoalFive());
