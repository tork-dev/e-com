...
import 'package:torganic/src/features/ai_recommendation/view/skin_care_goal/recomedation_goal_three.dart';
        ...
        body: ListView(
          children: [
            ...
            const LinearProgressSection(
              linearPercent: 2/6,
              linearPercentString: '2/6',
            ),
            const Gap(AppSizes.md),
            RadioQuestionWidget(
              question: QuestionAndValues().recommendationQuestionAndAns[
                  "skincare_goal_questions"]["questions"][1]["question"],
