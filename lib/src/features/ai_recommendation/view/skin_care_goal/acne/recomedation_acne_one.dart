...
class RecommendationAcneOne extends StatelessWidget {
  const RecommendationAcneOne({super.key});
          ...
          children: [
            ...
            RadioQuestionWidget(
              question: QuestionAndValues().recommendationQuestionAndAns[
                  "related_questions_based_on_primary_concern"]["acne"]["questions"][0]["question"],
              option: QuestionAndValues().recommendationQuestionAndAns[
                  "related_questions_based_on_primary_concern"]["acne"]["questions"][0]["options"],
            ),
            const Gap(AppSizes.md),
            ButtonRow(
              onTapNext: (){
                recommendationController.acneOneSelected.value = String.fromCharCode(65 + recommendationController.radioButtonSelectedValue.value!).toLowerCase();
                Log.d(recommendationController.acneOneSelected.toString());
