...
// import 'package:kirei/src/features/ai_recommendation/view/skin_care_goal/recomedation_goal_one.dart';
...
//
// class SkinCareHistoryNine extends StatelessWidget {
//   const SkinCareHistoryNine({super.key});
//
//   @override
...
//               linearPercent: 9/9,
//               linearPercentString: '9/9',
//             ),
//             const Gap(AppSizes.md),
//             RadioQuestionWidget(
//               question: QuestionAndValues().recommendationQuestionAndAns[
//                   "skincare_history_questions"]["questions"][7]["question"],
//               option: QuestionAndValues().recommendationQuestionAndAns[
//                   "skincare_history_questions"]["questions"][7]["options"],
//             ),
//             const Gap(AppSizes.md),
//             ButtonRow(
//               onTapNext: (){
//                 recommendationController.selectedSkinBurning.value = String.fromCharCode(65 + recommendationController.radioButtonSelectedValue.value!).toLowerCase();
//                 Log.d(recommendationController.selectedSkinBurning.toString());
//                 Get.to(()=> const RecommendationGoalOne());
