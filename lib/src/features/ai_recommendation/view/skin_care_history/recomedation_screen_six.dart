...
//
// class SkinCareHistorySix extends StatelessWidget {
//   const SkinCareHistorySix({super.key});
//
//   @override
...
//               linearPercent: 6/9,
//               linearPercentString: '6/9',
//             ),
//             const Gap(AppSizes.md),
//             RadioQuestionWidget(
//               question: QuestionAndValues().recommendationQuestionAndAns[
//                   "skincare_history_questions"]["questions"][4]["question"],
//               option: QuestionAndValues().recommendationQuestionAndAns[
//                   "skincare_history_questions"]["questions"][4]["options"],
//             ),
//             const Gap(AppSizes.md),
//             ButtonRow(
//               onTapNext: (){
...
//                 Log.d(recommendationController.selectedBasicSkinCare.toString());
