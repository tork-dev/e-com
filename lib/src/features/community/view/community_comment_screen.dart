                  ...
                  applyPadding: false,
                    ...
                    builderFunction: (BuildContext context, int index) =>
                        controller.isLoading.value
                          ...
                          title: Text(controller.communityCommentResponse.value.data![index].customerName!),
                          subtitle: Text(controller.communityCommentResponse.value.data![index].comment!, style: Theme.of(context).textTheme.labelMedium,),
                              )),
              );
            }),
          ),
